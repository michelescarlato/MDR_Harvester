...
namespace MDR_Harvester
{
    ...
    {
        public PostgreSQLCopyHelper<DataObject> dataObjectsHelper => data_objects_helper;
        public PostgreSQLCopyHelper<ObjectDataset> objectDatasetsHelper => object_datasets_helper;
        public PostgreSQLCopyHelper<ObjectTitle> objectTitlesHelper=> object_titles_helper;
        public PostgreSQLCopyHelper<ObjectInstance> objectInstancesHelper => object_instances_helper;
        public PostgreSQLCopyHelper<ObjectDate> objectDatesHelper => object_dates_helper;
        public PostgreSQLCopyHelper<ObjectContributor> objectContributorsHelper=> object_contributors_helper;
        public PostgreSQLCopyHelper<ObjectIdentifier>objectIdentifiersHelper=> object_identifiers_helper;
        public PostgreSQLCopyHelper<ObjectDescription> objectDescriptionsHelper => object_descriptions_helper;
        public PostgreSQLCopyHelper<ObjectDBLink> objectDbLinksHelper => object_db_links_helper;
        public PostgreSQLCopyHelper<ObjectPublicationType> objectPubTypesHelper => publication_types_helper;
        public PostgreSQLCopyHelper<ObjectComment> objectCommentsHelper => object_comments_helper;
        public PostgreSQLCopyHelper<ObjectTopic> objectTopicsHelper => object_topics_helper;
        public PostgreSQLCopyHelper<ObjectRight> objectRightsHelper => object_rights_helper;
        public PostgreSQLCopyHelper<ObjectRelationship> objectRelationshipsHelper => object_relationships_helper;
   
        
        private PostgreSQLCopyHelper<DataObject> data_objects_helper =
        ...
        private PostgreSQLCopyHelper<ObjectDataset> object_datasets_helper =
        ...
        private PostgreSQLCopyHelper<ObjectTitle> object_titles_helper =
        ...
        private PostgreSQLCopyHelper<ObjectInstance> object_instances_helper =
        ...
        private PostgreSQLCopyHelper<ObjectDate> object_dates_helper =
        ...
        private PostgreSQLCopyHelper<ObjectContributor> object_contributors_helper =
        ...
        private PostgreSQLCopyHelper<ObjectIdentifier> object_identifiers_helper =
        ...
        private PostgreSQLCopyHelper<ObjectDescription> object_descriptions_helper =
        ...
        private PostgreSQLCopyHelper<ObjectDBLink> object_db_links_helper =
        ...
        private PostgreSQLCopyHelper<ObjectPublicationType> publication_types_helper =
            new PostgreSQLCopyHelper<ObjectPublicationType>("sd", "object_publication_types")
                .MapVarchar("sd_oid", x => x.sd_oid)
                .MapVarchar("type_name", x => x.type_name);


        private PostgreSQLCopyHelper<ObjectComment> object_comments_helper =
        ...
        private PostgreSQLCopyHelper<ObjectTopic> object_topics_helper =
        ...
        private PostgreSQLCopyHelper<ObjectRight> object_rights_helper =
        ...
        private PostgreSQLCopyHelper<ObjectRelationship> object_relationships_helper =
