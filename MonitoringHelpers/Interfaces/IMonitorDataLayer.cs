...
public interface IMonDataLayer
{
    ...
    int FetchFileRecordsCount(int source_id, string source_type, int harvest_type_id = 1, 
        DateTime? cutoff_date = null, int days_ago = 0);
    int FetchFullFileCount(int source_id, string source_type, int harvest_type_id, int days_ago = 0);
