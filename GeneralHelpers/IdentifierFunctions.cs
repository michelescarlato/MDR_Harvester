...
public class IdentifierHelpers
{
    ...
    */
    ...
    public IdentifierDetails GetISRCTNIdentifierProps(string id_value, string study_sponsor)
    {
        ...
        IdentifierDetails idd = new IdentifierDetails(14, "Sponsor ID", null, study_sponsor, id_value);
...
public class IdentifierDetails
{
    ...
    public IdentifierDetails(int? _id_type_id, string? _id_type, int? _id_org_id, string? _id_org, string? _id_value)
    {
